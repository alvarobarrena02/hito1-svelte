...
<header>
	...
	<nav>
		...
		<ul>
			...
			<li aria-current={$page.url.pathname.startsWith('/delete') ? 'page' : undefined}>
	...
	<div class="corner">
		<a href="https://github.com/alvarobarrena02" target="_blank">
